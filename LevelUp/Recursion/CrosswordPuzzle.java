...
public class CrosswordPuzzle {
            ...
            for(int j=0;j<arr[0].length;j++){
                if(arr[i][j]=='-' || arr[i][j]==word.charAt(0)){
                    if(canPlaceHorizontally(arr,word,i,j)==true){
                        boolean[] weplaced = placeWordH(arr,word,i,j);
                        solution(arr,words,vidx+1);
                        unplaceH(arr,weplaced,i,j);
                    }
                    if(canPlaceVertically(arr,word,i,j)==true){
                        boolean[] weplaced = placeWordV(arr,word,i,j);
                        solution(arr,words,vidx+1);
    ...
    public static void unplaceH(char[][] arr,boolean[] weplaced,int i,int j){
    ...
    public static void unplaceV(char[][] arr,boolean[] weplaced,int i,int j){
